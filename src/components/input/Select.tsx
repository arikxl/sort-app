...
const Select = ({ options, defaultValue, onChange, isDisabled = false }: {
    options: SelectOptionsType[], defaultValue: string, isDisabled: boolean,
    ...
    return (
        <div className="inline-block relative w-48">
            ...
            <select defaultValue={defaultValue} onChange={onChange} disabled={isDisabled}
